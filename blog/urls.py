...
from .views import BlogsListCreateAPIView, BlogRetrieveUpdateDestroyAPIView ,BlogCardlistCreateAPIView,blogCardRetrieveUpdateDestroyAPIView,BlogCardDetailView
...
urlpatterns = [
    ...
    path('blogcard/<int:pk>/', BlogCardDetailView.as_view(), name='blogcard-detail'),
