...
class MetaTagsContacts(models.Model):
    ...
    image_filename = models.ImageField(upload_to='seo_contact_images/', null=True, blank=True)
    ...
    og_image = models.ImageField(upload_to='seo_contact_images/', null=True, blank=True)
    ...
    twitter_image = models.ImageField(upload_to='seo_contact_images/', null=True, blank=True)
